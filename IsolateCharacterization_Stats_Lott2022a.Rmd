...
#Hyp1 genus ###need to add distinct
...
#Hypothesis 1 for ATs
```{r}

#create a matrix summarizing UniqueAT presence/absence per Trial-HTST_Temp-Storage_Temp
...
#stress plot
stressplot(Hyp1_AT.nmds2)
#most points fall on line, proceed to nmds plot
